...
require("@infrastructure/database/prisma-schema-extensions");
...
const setup_1 = require("./docs/setup");
const swagger_middleware_1 = require("@interfaces/middlewares/swagger.middleware");
...
app.use(swagger_middleware_1.swaggerAuthMiddleware);
