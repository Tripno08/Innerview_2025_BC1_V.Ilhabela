...
estudanteRoutes.post('/dificuldade', (0, rbac_middleware_1.rbacMiddleware)([
...
estudanteRoutes.post('/avaliacao', (0, rbac_middleware_1.rbacMiddleware)([
    enums_1.CargoUsuario.PROFESSOR,
    enums_1.CargoUsuario.ESPECIALISTA,
    enums_1.CargoUsuario.COORDENADOR,
    enums_1.CargoUsuario.ADMINISTRADOR,
]), estudanteController.registrarAvaliacao);
estudanteRoutes.get('/:estudanteId/intervencoes/recomendacoes', (0, rbac_middleware_1.rbacMiddleware)([
    enums_1.CargoUsuario.PROFESSOR,
    enums_1.CargoUsuario.ESPECIALISTA,
    enums_1.CargoUsuario.COORDENADOR,
    enums_1.CargoUsuario.ADMINISTRADOR,
]), estudanteController.recomendarIntervencoes);
estudanteRoutes.get('/:estudanteId/progresso', (0, rbac_middleware_1.rbacMiddleware)([
    enums_1.CargoUsuario.PROFESSOR,
    enums_1.CargoUsuario.ESPECIALISTA,
    enums_1.CargoUsuario.COORDENADOR,
    enums_1.CargoUsuario.ADMINISTRADOR,
