...
exports.criarUsuarioSchema = zod_1.z.object({
    ...
    cargo: zod_1.z.nativeEnum(client_1.CargoUsuario).optional().default(client_1.CargoUsuario.PROFESSOR),
});
exports.atualizarUsuarioSchema = zod_1.z.object({
    ...
    senha: zod_1.z
        ...
        .max(100, 'Senha deve ter no máximo 100 caracteres')
        .optional(),
    cargo: zod_1.z.nativeEnum(client_1.CargoUsuario).optional(),
});
