...
import { DificuldadeAprendizagem, TipoDificuldade, CategoriaDificuldade } from '@domain/entities/dificuldade-aprendizagem.entity';
...
export declare class DificuldadeRepository extends BaseRepository<DificuldadeAprendizagem> implements IDificuldadeRepository {
    ...
    findByCategoria(categoria: CategoriaDificuldade): Promise<DificuldadeAprendizagem[]>;
    ...
    private parseDate;
    private mapCategoriaParaPrisma;
    private mapTipoToCategoria;
    private obterTipoDaCategoria;
}
