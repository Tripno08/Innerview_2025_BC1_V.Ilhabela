...
class Usuario {
    ...
    validar() {
        ...
        const cargoValues = Object.values(client_1.CargoUsuario) || Object.values(AdminCargos);
    ...
    ehAdministrador() {
        return this.cargo === (client_1.CargoUsuario.ADMINISTRADOR || AdminCargos.ADMINISTRADOR);
    }
    podeGerenciarUsuarios() {
        const adminCargos = [
            client_1.CargoUsuario.ADMINISTRADOR || AdminCargos.ADMINISTRADOR,
            client_1.CargoUsuario.DIRETOR || AdminCargos.DIRETOR,
            client_1.CargoUsuario.COORDENADOR || AdminCargos.COORDENADOR
        ];
